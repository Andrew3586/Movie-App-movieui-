...
function About() {
  return (
    <div className="about2">
      ...
      <h4 className="about">
        Real Dummy CONTENT <br></br>Lorem Ipsum is simply dummy text of the printing
        ...
        versions of Lorem Ipsum. Contrary to popular belief, Lorem Ipsum is not
        ...
        from a line in section 1.10.32.<br></br> The standard chunk of Lorem
        ...
        English versions from the 1914 translation by H. Rackham. It is a long
